...
var UrlInput = /** @class */ (function (_super) {
    ...
    function UrlInput() {
        ...
        _this.debouncedFetch = debounce(function (url) { return __awaiter(_this, void 0, void 0, function () {
            var error_1;
            var _this = this;
        ...
        _this.validateUrl = function () {
            ...
            if (input) {
                var parsed = parseURL(input.value);
    ...
    UrlInput.prototype.render = function () {
        ...
        return createElement("input", __assign({ type: "url", style: inputStyle, onChange: this.validateUrl }, props, { ref: this.inputRef }));
    };
    return UrlInput;
}(Component));
...
export { Image, ActionButton, UrlInput, Mock };
